  ...
  return (
    <div className="pt-20 pb-8 px-4 max-w-5xl mx-auto">
      ...
      <div className="mb-12">
        ...
        <p className="text-xl text-gray-600">Insights, news, and stories from the world of disc golf.</p>
      </div>

      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        {posts.map((post) => (
          <article key={post.id} className="bg-white border border-gray-200 rounded-2xl overflow-hidden shadow-sm hover:shadow-md active:scale-[0.99] transition-all flex flex-col">
