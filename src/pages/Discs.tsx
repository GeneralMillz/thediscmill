  ...
  return (
    <div className="pt-20 pb-8 px-4 max-w-7xl mx-auto">
      <Helmet>
        ...
        <meta name="description" content="Browse 10,000+ disc golf discs with flight numbers, stability ratings, and buying links." />
      </Helmet>
      ...
      <div className="mb-10">
        <div className="flex items-center gap-3 mb-3">
          ...
          <div>
            <h1 className="text-4xl font-black text-gray-900 tracking-tight">Disc Catalog</h1>
          </div>
        </div>
        ...
        {!loading && (
          <div className="flex items-center gap-4 mt-4">
            ...
            <Link
              to="/manufacturers"
              className="inline-flex items-center gap-1.5 text-sm font-semibold text-gray-500 bg-gray-100 px-3 py-1 rounded-full hover:bg-indigo-50 hover:text-indigo-600 transition-colors"
            >
      ...
      <div className="relative mb-6">
        ...
        <input
          ...
          className="w-full pl-12 pr-4 py-3.5 bg-white border border-gray-200 rounded-2xl text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent shadow-sm text-sm"
        />
        {search && (
          ...
          <button
            ...
            className={`shrink-0 px-4 py-2 rounded-xl text-sm font-semibold transition-all ${
              category === cat
                ...
                : 'bg-white text-gray-600 border border-gray-200 hover:border-indigo-300 hover:text-indigo-600 active:bg-indigo-100'
            }`}
          >
            {cat}
      ...
      <div className="mb-6">
        <button
          ...
          className="flex items-center gap-2 text-sm font-semibold text-gray-600 mb-3 lg:hidden"
        >
        ...
        <div className={`space-y-4 ${showFilters ? 'block' : 'hidden lg:block'}`}>
          ...
          {/* Stability pills */}
          <div>
            <p className="text-xs font-bold text-gray-400 uppercase tracking-widest mb-2">Stability</p>
            <div className="flex gap-2 flex-wrap">
              {STABILITIES.map(s => {
      ...
      <div className="flex items-center justify-between mb-6">
        <div className="flex items-center gap-3">
          <p className="text-sm font-semibold text-gray-500">
            {loading ? 'Loading…' : (
              <><span className="text-gray-900 font-black">{filtered.length}</span> discs</>
            )}
          </p>
          {hasFilters && (
        ...
        <select
          ...
          className="text-xs font-semibold text-gray-600 bg-white border border-gray-200 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-indigo-400"
        >
      ...
      {loading ? (
        ...
        <div className="text-center py-24 bg-white rounded-3xl border-2 border-dashed border-gray-200">
          <DiscIcon className="w-12 h-12 text-gray-200 mx-auto mb-4" />
          <h3 className="text-xl font-bold text-gray-900 mb-2">No discs found</h3>
