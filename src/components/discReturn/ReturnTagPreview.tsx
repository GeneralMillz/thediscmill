  ...
  return (
    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
      ...
      <div className="grid grid-cols-2 gap-4 no-print">
        <button 
          onClick={handlePrint}
          className="flex items-center justify-center py-4 bg-gray-900 text-white rounded-2xl font-bold hover:bg-black transition-colors"
        >
      ...
      <div className="bg-amber-50 p-6 rounded-2xl border border-amber-100 no-print">
